...
app.get('/login', function(req, res) {
  ...
  var scope = 'user-read-private user-read-email user-top-read user-read-birthdate user-library-read user-follow-read streaming playlist-read-collaborative';
